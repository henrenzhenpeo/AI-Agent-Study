...
examples_template = PromptTemplate.from_template("单词：{word},反义词：{antonym}")
...
few_shot_prompt = FewShotPromptTemplate(
    example_prompt=examples_template, # 示例数据的模版
    ...
    input_variables=['input_word'] #声明在前缀或后缀所需要注入的变量名
)
